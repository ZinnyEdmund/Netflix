        ...
        <div className="footer">
          ...
          <div className="footer-column">
            <ul>
              ...
              <li>
                <a href="https://jobs.netflix.com/">Job</a>
              </li>
              <li>
          ...
          <div className="footer-column">
            <ul>
              <li>
                <a href="https://www.netflix.com/ng/login?nextpage=https%3A%2F%2Fwww.netflix.com%2Fyouraccount">
                  Accounts
                </a>
              </li>
              <li>
                <a href="https://help.netflix.com/en/node/14361">
                  Ways to Watch
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="https://www.netflix.com/ng/browse/genre/839338">
                  Only on Netflix
                </a>
              </li>
            </ul>
